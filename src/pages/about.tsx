        ...
        <div class="space-y-8">
          <div class="bg-white rounded-xl shadow-sm p-6">
            <p class="text-gray-700 text-lg leading-relaxed">
              这是一个演示 <strong class="text-blue-600">Islands 架构</strong> 的现代 MPA（多页面应用）项目，结合了服务端渲染的性能优势和客户端交互的灵活性。
            </p>
          </div>
          ...
          <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <ol class="space-y-4">
              <li class="flex items-start gap-3">
                <span class="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-800 rounded-full flex items-center justify-center text-sm font-semibold">1</span>
                <div class="text-gray-700">页面在服务端使用 Preact 渲染为完整 HTML</div>
              </li>
              <li class="flex items-start gap-3">
                <span class="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-800 rounded-full flex items-center justify-center text-sm font-semibold">2</span>
                <div class="text-gray-700">交互式组件被标记为 <code class="bg-gray-100 text-gray-800 px-1 py-0.5 rounded text-sm font-mono">data-island</code></div>
              </li>
              <li class="flex items-start gap-3">
                <span class="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-800 rounded-full flex items-center justify-center text-sm font-semibold">3</span>
                <div class="text-gray-700">客户端仅加载和 hydrate 这些岛组件</div>
              </li>
              <li class="flex items-start gap-3">
                <span class="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-800 rounded-full flex items-center justify-center text-sm font-semibold">4</span>
